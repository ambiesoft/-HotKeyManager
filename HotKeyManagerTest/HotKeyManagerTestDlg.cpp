...
// HotKeyManagerTestDlg.cpp : 実装ファイル
//
...
#include "../HotKeyManager/exported.h"
...
CHotKeyManagerTestDlg::CHotKeyManagerTestDlg(CWnd* pParent /*=nullptr*/)
...
BEGIN_MESSAGE_MAP(CHotKeyManagerTestDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_HOTKEYOPTION, &CHotKeyManagerTestDlg::OnBnClickedButtonHotkeyoption)
END_MESSAGE_MAP()


// CHotKeyManagerTestDlg メッセージ ハンドラー

BOOL CHotKeyManagerTestDlg::OnInitDialog()
{
...
void CHotKeyManagerTestDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CHotKeyManagerTestDlg::OnPaint()
{
	if (IsIconic())
	{
...
//  システムがこの関数を呼び出します。
HCURSOR CHotKeyManagerTestDlg::OnQueryDragIcon()
{
